...
from plumi.taxonomies.vocabs  import vocab_set as vocabs
from plumi.taxonomies.config import TOPLEVEL_TAXONOMY_FOLDER , GENRE_FOLDER, CATEGORIES_FOLDER, COUNTRIES_FOLDER, SUBMISSIONS_FOLDER, SE_ASIA_COUNTRIES, LANGUAGES_FOLDER
...
def setupVarious(context):
    ...
    if context.readDataFile('plumi.taxonomies_various.txt') is None:
        return
